...
class MRDataProcessor(DataProcessor):
    """
    ...
    def get_train_examples(self, data_dir: str) -> List[InputExample]:
        ...
        """
        return self._create_examples(os.path.join(data_dir, MRDataProcessor.TRAIN_FILE_NAME), "train")
    ...
    def get_dev_examples(self, data_dir: str) -> List[InputExample]:
        ...
        """
        return self._create_examples(os.path.join(data_dir, MRDataProcessor.DEV_FILE_NAME), "dev")
    ...
    def get_test_examples(self, data_dir) -> List[InputExample]:
        ...
        """
        return self._create_examples(os.path.join(data_dir, MRDataProcessor.TEST_FILE_NAME), "test")
    ...
    def get_unlabeled_examples(self, data_dir) -> List[InputExample]:
        ...
        """
        return self._create_examples(os.path.join(data_dir, MRDataProcessor.UNLABELED_FILE_NAME), "unlabeled")

    def get_labels(self) -> List[str]:
        """This method returns all possible labels for the task."""
        return MRDataProcessor.LABELS
    ...
    def _create_examples(self, path, set_type, max_examples=-1, skip_first=0):
        ...
        with open(path) as f:
            ...
            for idx, row in enumerate(reader):
                ...
                label = row[MRDataProcessor.LABEL_COLUMN]
                text_a = row[MRDataProcessor.TEXT_A_COLUMN]
                text_b = row[MRDataProcessor.TEXT_B_COLUMN] if MRDataProcessor.TEXT_B_COLUMN >= 0 else None
...
PROCESSORS[MRDataProcessor.TASK_NAME] = MRDataProcessor
